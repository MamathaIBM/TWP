...
@Component({
  selector: 'app-st-admin-implement-phase-exit-activity-list',
  templateUrl: './st-admin-implement-phase-exit-activity-list.component.html',
  styleUrls: ['./st-admin-implement-phase-exit-activity-list.component.css']
})
export class StAdminImplementPhaseExitActivityListComponent implements OnInit {
